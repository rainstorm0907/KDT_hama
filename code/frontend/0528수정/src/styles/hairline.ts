export const hairline = {
  ...
  panelSoft:
    'border border-[#C6CDD8]/88 bg-white/72 shadow-[0_6px_24px_rgba(29,29,31,0.10),inset_0_1px_0_rgba(255,255,255,0.94)] backdrop-blur-xl',
  card:
    'border border-[#C9CFDA]/92 bg-white/82 shadow-[0_4px_20px_rgba(29,29,31,0.12),0_1px_4px_rgba(29,29,31,0.06)] backdrop-blur-xl',
  cardHover:
    'hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(29,29,31,0.15),0_1px_4px_rgba(29,29,31,0.06)]',
  image: 'bg-[#F3F4F6]',
  control:
